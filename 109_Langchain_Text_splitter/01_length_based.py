...
text = """LangChain is a framework for developing applications powered by language models. It provides a standard interface for working with language models, making it easier to build applications that can understand and generate human language. LangChain supports various tasks such as text generation, summarization, translation, and more."""
...
print(f"Number of chunks: {result[1]}")